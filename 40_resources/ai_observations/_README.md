...
> 위상은 [00_foundation/WHITEPAPER.md](../../00_foundation/WHITEPAPER.md) §5 L1 참조.
> **부패 허용** — 정제는 L3 씽크탱크가 한다. 사용자는 채우지 않는다.
> 작성 규칙은 [10_guides/03_AI_관찰_로그_작성_규칙.md](../../10_guides/03_AI_관찰_로그_작성_규칙.md) 참조 (단일 출처).
...
상세는 `10_guides/03_AI_관찰_로그_작성_규칙.md`. 요약:
