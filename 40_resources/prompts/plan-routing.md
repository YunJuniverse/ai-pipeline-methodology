...
- No planning snapshots exist yet in `30_dev/snapshots/plans/`
- Starting a new project or major pivot

## Instructions

- Read all files in `briefs/` and `briefs/updates/` (if any).
- Read `10_guides/00_AI_기획_프로젝트_운영_원칙.md`.
- Read `10_guides/01_AI_기획_오케스트레이션_지침서.md`.
...
### 작성할 문서 (6종 전체)
1. 사업기획서     → 30_dev/snapshots/plans/business/v1-YYYY-MM-DD.md
2. 서비스기획서   → 30_dev/snapshots/plans/service/v1-YYYY-MM-DD.md
3. 운영기획서     → 30_dev/snapshots/plans/ops/v1-YYYY-MM-DD.md
4. 마케팅기획서   → 30_dev/snapshots/plans/marketing/v1-YYYY-MM-DD.md
5. 브랜드기획서   → 30_dev/snapshots/plans/brand/v1-YYYY-MM-DD.md
6. 프로젝트관리   → 30_dev/snapshots/plans/pm/v1-YYYY-MM-DD.md
