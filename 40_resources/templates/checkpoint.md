...
4. 첫 작업이 끝나면 본 checkpoint 를 갱신 — 형식: `00_foundation/WHITEPAPER.md` §2-2.
...
- 도메인 식별자 (`project.domain`) — `40_resources/skeletons/_README.md` §4 컨벤션 참조.
