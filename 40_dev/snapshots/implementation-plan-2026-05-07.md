...
> 기준 백서: `10_foundation/WHITEPAPER.md` v0.2.0
> 작성일: 2026-05-07
...
- `60_tools/methodology.py observe` 명령 설계
- L1 관찰 로그 lint 규칙 초안
...
| METH-007 | L1 관찰 로그 생성·검증 흐름 구현 | A | METH-006 | `methodology observe`가 `50_resources/ai_observations/`에 규칙 준수 파일을 만든다 |
...
- 관찰 로그 샘플 1건이 `20_guides/03_AI_관찰_로그_작성_규칙.md`를 통과한다.
