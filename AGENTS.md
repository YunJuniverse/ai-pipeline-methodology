...
After Phase 1 → "기획서 작성 시작해"

### Gate 2: Planning Approval
After Phase 2 → "개발명세서 작성해"

### Gate 3: Development Spec Approval
After Phase 3 → "MVP 개발 시작해"

### Gate 4: Build Review
After Phase 5 → "환류 작업 진행해"

### Gate 5: Next Sprint Approval
After Phase 8 → "개발명세서 업데이트하고 N차 개발 시작해"

### Gate 6: Final Confirmation
Human declares "개발 완료" → "기획서 최종 업데이트해"
