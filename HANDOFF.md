...
- **Working on**: METH-112 대시보드 슬림화 (feat/dashboard-slim, PR 대기). 리서치 스냅샷 후 5탭→3탭(상태/문서/관계그래프). 운영 콘솔·커맨드팔레트·스택bento·통합뷰(중복)·가이드백서·node_contents 제거. 상태 중심 순수 진척 뷰. 테스트 7개, 브라우저 검증.
