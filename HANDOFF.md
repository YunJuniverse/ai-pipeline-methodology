...
- **Working on**: **METH-145 훅 한글 경로 수정**(branch `fix/hook-sync-path-quotepath`) — 수정·재증명 완료, land 후 전파+훅 재설치+METH-144 잔여 push(ai-icons·lifeManager) 남음. 직전 완결: METH-143 · METH-142 캡슐 루프 4회차 — 수거 24건→판정→반영→전파 2회를 한 세션에 완주(#155·#157·#158·#159·#160·#161, maincheck 전건 ✓).
