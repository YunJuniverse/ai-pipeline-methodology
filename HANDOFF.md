...
- **Working on**: **METH-136 전파 종결 — 12/12**(2026-08-07) — 운영 모드 키워드 트리거가 전 repo 반영. 이제 어느 repo에서든 '실험 모드'·'자율주행' 키워드가 지침 28/29 본문 로드를 부른다. branch `chore/sync-propagate-meth-136`. 직전: METH-133/134/135 전파 12/12.
