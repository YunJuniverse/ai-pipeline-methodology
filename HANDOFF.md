...
- **Working on**: **AI 디자인 방법론 리서치 완료** (2026-07-29) — 영상·이미지·PPT·웹디자인 4도메인 병렬 웹리서치, 교차 공통 원칙 9종·구성안(지침 25~27 신설+20 v2·22 v3 보강) 도출. 스냅샷 정본, METH-129 등록(구성안 확정 = 사람 게이트). branch `docs/research-ai-design-2026-07`, PR 대기. 직전: 트리아지 12/12 종결(#132 머지).
