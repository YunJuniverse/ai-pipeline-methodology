...
- **Working on**: METH-078 **평가·가드레일 지침 심화**(guide 17) — **기획서 지침군(12~17) 심화 완결**. 웹리서치(NIST AI RMF·ISO 42001·EU AI Act GPAI·G-Eval·RAGAS·OTel GenAI·Garak)로 신규: LLM-judge bias·에이전트 trajectory eval·RAG 메트릭·eval 데이터 위생·거버넌스 3축 매핑·레드팀 게이트·OTel 정렬. README 갱신. Class A. PR 대기(main 직접).
- **Current mode**: fullstack
- **Next TODO**: ① **문서별 심화 프로그램 대부분 완료** — 템플릿 13종(063~071)+기획서 지침군 6종(073~078). 남은 후보: agency/ops 템플릿(proposal·qa·operation·profitability·execution-plan·wbs), 나머지 지침(00~09 메타·18~21). ② **홀드 다운스트림 sync 재개** — ai-icons(dirty+커스텀 guide 충돌)·cafe24-renewal·icons-invest clean 후. ③ **누적 지침 심화분(073~078) 다운스트림 sync**(다음 sync에 포함). **프로세스: branch-first 준수.**
- **Blockers**: none

## Active Links

- Current PR: METH-078 평가·가드레일 지침 (신규·지침군 완결) · 심화 063~077 = #53~#66 머지 완료
- Current issue:
- Relevant ADRs:
