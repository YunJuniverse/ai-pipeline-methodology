...
- **Working on**: **METH-122 종결 — 전파 11/11** (2026-07-29) — 전 repo가 rotate·wrap 경성 한도·boot 신선도·build 가드 획득(P3·P6 차단). branch `chore/sync-propagate-meth-122`, PR 대기. 다음 구현: METH-118(프롬프팅 코칭) 또는 지침 123·124 — 사람 지정 대기. 직전: METH-122 구현(#123 머지).
