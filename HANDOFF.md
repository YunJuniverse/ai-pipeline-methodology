...
- **Working on**: **지침 23·24 신설 완료** (2026-07-29) — 검증 규범(METH-123: 무음 실패·내용 기준 검증·검증불가 등록부) + 착수 게이트(METH-124: 정본·진단 재검증·해석 계약·경계 원문 검증). branch `docs/guides-23-24-verification-kickoff`, PR 대기. 머지 후 sync-all 전파(20_guides shared). 직전: METH-118 종결·전파 11/11(#125·#126 머지).
