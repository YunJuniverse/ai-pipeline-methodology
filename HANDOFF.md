...
- **Working on**: 여러 dashboard 동시 운영 + 브랜치별 spawn 완성. methodology dashboard 자동 포트 할당(8765-8799), --branch worktree 격리, list/stop 서브커맨드, ~/.methodology-dashboards.json 레지스트리. dashboard UI Local Dashboards + Branches 카드.
- **Current mode**: fullstack
- **Next TODO**: 3개 적용 프로젝트에 multi-dashboard fix sync 전파, METH-020 (MC-002 승급, F-005 N=4 도달 — 더 명백)
- **Blockers**: none
