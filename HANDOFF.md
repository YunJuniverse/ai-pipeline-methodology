...
- **Working on**: METH-074 **마케팅기획서 지침 심화**(guide 13). 기획서 지침군 2번째 — 웹리서치(Reforge·Meridian·Ehrenberg-Bass·GEO/AEO·규제)로 §6에 7항목 신설: GEO/AEO·포스트쿠키 측정(MMM+증분성+MER)·Growth Loops·채널 유닛경제·브랜드/퍼포먼스(60:40·95-5)·실험 엄밀성·AI 공시/규제. §8·§16·§19.9·README 갱신. Class A. PR 대기(main 직접).
- **Current mode**: fullstack
- **Next TODO**: ① **기획서 지침군 심화 계속** — 브랜드(14)·PM(15)·AI기능(16)·평가(17). ② **홀드 다운스트림 sync 재개** — ai-icons(dirty+커스텀 guide 충돌)·cafe24-renewal·icons-invest clean 후. ③ 심화분(073~074) 다음 sync에 포함. **프로세스: branch-first 준수.**
- **Blockers**: none

## Active Links

- Current PR: METH-074 마케팅기획서 지침 (신규) · 심화 063~073 = #53~#62 머지 완료
- Current issue:
- Relevant ADRs:
