...
`python3 60_tools/methodology.py status --path <project>` 출력:
...
- 메타 관찰: `70_meta/observations/2026-05-12_v3.1-to-v3.2-migration.md` §F-001
- RFC-001 (예정): `70_meta/rfc/RFC-001_status-upstream-commit-check.md`
- 코드: `60_tools/methodology.py` `cmd_status`
