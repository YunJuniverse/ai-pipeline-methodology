# 70_meta/catalog/ — 메타-Catalog (방법론 자체의 반복 마찰)

> 본 저장소 운영에서 반복되는 *방법론·프로세스·문서* 차원의 마찰.
> 외부 프로젝트에 주입되지 **않습니다** (`70_meta/_README.md` §2 이중 안전망).

## 도메인 Catalog와의 결정적 차이

| 항목 | `50_resources/catalog/` | `70_meta/catalog/` (본 폴더) |
|---|---|---|
| ID 접두 | `C-NNN` | **`MC-NNN`** |
...
[`50_resources/catalog/_README.md`](../../50_resources/catalog/_README.md) 와 **동일**. 단:
- `id`: `MC-NNN` (3자리 제로패딩)
