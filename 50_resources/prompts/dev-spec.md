...
- Human has approved the plan snapshot (`40_dev/snapshots/plan-YYYY-MM-DD.md`)
- Human has given explicit instruction to proceed to dev spec
- No dev spec exists yet for this planning cycle

## Instructions

- Read the approved plan snapshot from `40_dev/snapshots/`.
...
- Write the result to `40_dev/snapshots/dev-spec-YYYY-MM-DD.md`.
...
> Source plan: 40_dev/snapshots/plan-YYYY-MM-DD.md
